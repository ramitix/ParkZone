...
if(run==true){
  ...
  function init(){
    ...
    for(var i=0;i<car_no;i++){
      ...
      else if(color_rand > 0.2 && color_rand < 0.3){
        var color = "#E22322";
      }
        else if(color_rand > 0.3 && color_rand < 0.4){
          var color = "#fff";
        }
        else if(color_rand > 0.4 && color_rand < 0.8){
          var color = "#F9D111";
        }
    ...
    //road4 4 v from right
    var road = new drawroad();
    road.x = 1050, road.y = 0, road.width = 160, road.height = h;
    roads.push(road);
    
    //road5 2 v from right
    var road = new drawroad();
    road.x = 450, road.y = 0, road.width = 160, road.height = h ;
    roads.push(road);
    
    //road6 1 v from right
    var road = new drawroad();
    road.x = 120, road.y = 0, road.width = 160, road.height = h;
    roads.push(road);
